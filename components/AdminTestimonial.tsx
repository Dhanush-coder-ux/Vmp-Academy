        ...
        {loading && testimonials.length === 0 ? (
          ...
          <div className="space-y-6">
            {testimonials.map((testimonial) => (
              <div key={testimonial.id} className="bg-white border border-gray-800 rounded-lg shadow-md p-6">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <div className="mt-3 text-sm">
                      ...
                      {testimonial.grade && <p className="text-gray-600">Grade: {testimonial.grade}</p>}
