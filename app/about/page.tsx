    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className='relative flex flex-col w-full justify-center py-20 sm:py-16'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto mb-16">
          <div className="block p-6  bg-black border border-gray-800 rounded-lg shadow-s transition-colors">
            ...
            <p className="font-normal text-white">Our educators are passionate about student success</p>
          </div>
          
          <div className="block p-6  bg-black border border-gray-800 rounded-lg shadow-sm  transition-colors">
            ...
            <p className="font-normal text-white">Focused approach to achieve academic targets</p>
          </div>
          ...
          <div className="block p-6   bg-black border border-gray-800 rounded-lg shadow-sm  transition-colors">
            ...
            <p className="font-normal text-white">Cutting-edge teaching techniques for better learning</p>
          </div>
          ...
          <div className="block p-6   bg-black border border-gray-800 rounded-lg shadow-sm  transition-colors">
            ...
            <p className="font-normal text-white">Personalized attention for every student</p>
          </div>
        </div>

        {/* What Makes Us Different Section */}
        <div className="max-w-4xl mx-auto p-8  bg-black border border-gray-800 rounded-lg shadow-sm  transition-colors">
